...
urlpatterns = [
    ...
    path('past-due-detail/<int:pk>/<str:msg>', PastDueDetailView.as_view(), name='past_due_detail_msg'),
    ...
    path('car-return-detail/<int:pk>/<str:msg>', CarReturnDetailView.as_view(), name='car_return_detail_msg')
]